...
export function NotificationBell({ userId }: { userId: string }) {
  ...
  return <div ref={rootRef} onMouseLeave={() => setOpen(false)} className="relative">
    ...
    {open && <div className="absolute right-0 top-10 w-[min(390px,calc(100vw-2rem))] overflow-hidden rounded-[1.5rem] border border-zinc-200 bg-white shadow-2xl">
