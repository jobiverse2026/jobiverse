  ...
  return (
    <html lang="en-IN" data-scroll-behavior="smooth">
      <body>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify({"@context":"https://schema.org","@type":"Organization",name:"JobiVerse",legalName:"MOHAMMAD AMIR MOHAMMAD ASLAM ANSARI",url:process.env.NEXT_PUBLIC_SITE_URL??"https://jobiverse.in",logo:`${process.env.NEXT_PUBLIC_SITE_URL??"https://jobiverse.in"}/images/branding/jobiverse-logo.svg`,email:"jobiverse@outlook.com",telephone:"+91-7738832231",address:{"@type":"PostalAddress",streetAddress:"Room No. 25, Plot No. 70, Malad (W)",addressLocality:"Mumbai",addressRegion:"Maharashtra",postalCode:"400095",addressCountry:"IN"},sameAs:["https://www.linkedin.com/in/jobiverse","https://www.instagram.com/jobiverse__/","https://www.facebook.com/profile.php?id=61592181941812","https://www.youtube.com/@Jobiverse2026"],description:"Indian recruitment and HR technology platform supporting employers, professionals, students and service creators."})}}/>
        <AuthProvider>
          <Navbar />
          <LogoutSuccessNotice />
