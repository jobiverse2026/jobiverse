...
export default async function CandidateDashboardPage() {
  ...
  const [profileResult, applicationsResult, interviewsResult, offersResult, savedResult] = await Promise.all([
    supabase.from("candidate_profiles").select("profile_completion, headline, resume_path").eq("user_id", user.id).maybeSingle(),
