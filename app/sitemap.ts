...
export default async function sitemap():Promise<MetadataRoute.Sitemap>{
  ...
  const pages=[["",1,"daily"],["/jobs",1,"daily"],["/services",.9,"weekly"],["/pricing",.8,"weekly"],["/employers",.9,"weekly"],["/candidates",.9,"weekly"],["/students",.9,"weekly"],["/career-services",.8,"weekly"],["/earn-with-jobiverse",.8,"weekly"],["/marketplace",.9,"daily"],["/why-jobiverse",.8,"monthly"],["/about",.7,"monthly"],["/industries",.7,"monthly"],["/resources",.7,"weekly"],["/guides",.8,"weekly"],...["features","employer","candidate","student","creator","recruiter"].map(slug=>[`/guides/${slug}`,.7,"weekly"] as const),["/contact",.7,"monthly"],["/privacy-policy",.3,"yearly"],["/refund-policy",.3,"yearly"],["/terms",.3,"yearly"]] as const;
  const now=new Date();
